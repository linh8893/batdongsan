...
class Acreage_lever extends MY_Controller{
    public function __construct() {
        parent::__construct();
        $this->load->model("M_acreage_lever");
    }
    ...
    public function create(){
        ...
        $this->form_validation->set_rules('min_value','Giá trị thấp nhất','required|xss_clean');
        $this->form_validation->set_rules('max_value','Giá trị cao nhất','required|xss_clean');
