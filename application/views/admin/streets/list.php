...
<div class="row" id="page-header">
    ...
    <div class="col-md-6 col-lg-4">
        ...
        <a href="<?=base_url();?>admin/streets/create" class="btn no-radius btn-primary" title="Thêm mới"><i class="fa fa-plus-circle"></i> Thêm mới</a>
            ...
            <table class="table table-bordered table-condensed" id="datatable">
                <thead>
                    <tr>
                        ...
                        <th style="width: 32%;">Tên đường / phố</th>
                ...
                <tbody>
                    ...
                    <tr id="item-<?=$row->id;?>">
                        ...
                        <td class="text-center">
                            <a href="<?=base_url();?>admin/streets/switch_status/<?=$row->id;?>" class="btn <?=$row->status==1?'text-success':'text-danger';?>"><i class="fa fa-lightbulb-o fa"></i></a>
                        </td>
                        <td style="width: 10%; text-align: center;">
                            <a href="<?=base_url();?>admin/streets/edit/<?=$row->id;?>" class="btn text-primary"><i class="fa fa-edit"></i></a>
                            <a href="javascript: confim_delete('<?=base_url();?>admin/streets/delete_item/<?=$row->id;?>');" class="btn text-danger"><i class="fa fa-trash-o"></i></a>
                        </td>
