                ...
                <div class="panel-body ">
                    ...
                    <div class="row " >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php $groups_code=set_value('groups_code')==""?$item->groups_code:set_value('groups_code');
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Giá </label>
                                <input type="text" name="price" value="<?=set_value('price')==""?$item->price:set_value('price');?>" class="form-control">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="acreage" value="<?=set_value('acreage')==""?$item->acreage:set_value('acreage');?>" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?=set_value('frontside')==""?$item->frontside:set_value('frontside');?>" name="frontside" class="form-control">
                         ...
                         <div class="col-md-3">
                            <div class="form-group">
                                <label>Mặt sau</label>
                                <input type="text" value="<?=set_value('backside')==""?$item->backside:set_value('backside');?>" name="backside" class="form-control">
                         ...
                         <div class="col-md-3">
                            <div class="form-group">
                                <label>Số tầng</label>
                                <input type="text" value="<?=set_value('floor')==""?$item->floor:set_value('floor');?>" name="floor" class="form-control">
                         ...
                         <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="room" value="<?=set_value('room')==""?$item->room:set_value('room');?>" class="form-control">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="toilet" value="<?=set_value('toilet')==""?$item->toilet:set_value('toilet');?>" class="form-control">
            ...
            <div class="panel panel-primary no-radius" >
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control"  id="slug" name=slug value="<?=set_value('slug')==""?$item->slug:set_value('slug');?>" placeholder="">
                        <div class="error"><?=form_error('slug');?></div>
                    </div>
                    <div class="form-group">
                        <label>Mô tả ngắn</label>
                        <textarea name="description" class="form-control" rows="2" placeholder=""><?=set_value('description')==""?$item->description:set_value('description');?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" class="form-control" rows="5" placeholder=""><?=set_value('content')==""?$item->content:set_value('content');?></textarea>
