...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input class="form-control" name="he_so" value="<?=set_value('he_so')==""?$item->he_so:set_value('he_so');?>">
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>Hệ nhân</label>
            <?php $he_nhan=set_value('he_nhan')==""?$item->he_nhan:set_value('he_nhan');?>
            <select name="he_nhan"  class="form-control">
                <option <?=$he_nhan==0?'selected':'';?> value="0">Không</option>
                <option <?=$he_nhan==1?'selected':'';?> value="1">Có </option>
            </select>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select name="groups_type" class="form-control">
                ...
                <option <?=$groups_type==1?"selected":"";?> value="1">Bất động sản bán</option>
                <option <?=$groups_type==2?"selected":"";?> value="2">Bất động cho thuê</option>
            </select>
