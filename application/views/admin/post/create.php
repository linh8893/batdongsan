        ...
        <div class="panel panel-default no-radius">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" id="content" class="form-control" rows="10" ><?=set_value('content');?></textarea>
    ...
    <div class="col-md-3">
        <div class="panel panel-default no-radius">
            ...
            <?php foreach ($categories as $row) {
                ?>
                <div class="radio">
                    <label><input type="radio"  <?=set_value('categories_id')==$row->id?"checked":"";?>  value="<?=$row->id;?>" name="categories_id"><?=$row->title;?></label>
                </div>
                <?php
            }?>
            </div>
