<div class="row" id="page-header">
    ...
    <div class="col-md-6 col-lg-4">
        ...
        <a href="<?=base_url();?>admin/posts" class="btn no-radius btn-success" title="Xem danh sách"><i class="fa fa-list"></i> Xem danh sách</a>
...
<div class="row">
    <div class="col-md-9">
        <div class="panel panel-default no-radius">
            <div class="panel-heading no-radius">
                <i class="fa fa-edit"></i> Nội dung bài viết
            </div>
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" id="content" class="form-control" rows="10" ><?=set_value('content')==""?$item->content:set_value('content');?></textarea>
    ...
    <div class="col-md-3">
        <div class="panel panel-default no-radius">
            <div class="panel-heading no-radius">
                <i class="fa fa-book"></i> Chuyên mục bài viết
            </div>
            <div class="panel-body">
            <?php 
            $categories_id=set_value("categories_id")==""?$item->categories_id:set_value('categories_id');
            foreach ($categories as $row) {
                ?>
                <div class="radio">
                    <label><input type="radio" <?=$row->id==$categories_id?"checked":"";?>  value="<?=$row->id;?>"  name="categories_id"><?=$row->title;?></label>
                </div>
                <?php
            }?>
            </div>
