    ...
    <div class="col-md-3">    
        <div class="form-group">
            ...
            <select class="form-control" name="type">
                ...
                <option <?=$type=="Phường"?"selected":"";?>  value="Phường" > Phường</option>
                <option <?=$type=="Xã"?"selected":"";?>  value="Xã" >Xã</option>
                <option <?=$type=="Thị trấn"?"selected":"";?>  value="Thị trấn" >Thị trấn</option>
            </select>
        </div>
    </div>  
    <div class="col-md-3">
