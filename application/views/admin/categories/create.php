            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <select name="group" class="form-control" >
                        ...
                        <option <?=set_value('group')=="cam-nang-tu-van"?'selected':'';?> value="cam-nang-tu-van">Cẩm nang tư vấn</option>
                        <option <?=set_value('group')=="chu-de"?'selected':'';?> value="chu-de">Chủ đề</option>
                    </select>
                </div>
                <div class="form-group">
