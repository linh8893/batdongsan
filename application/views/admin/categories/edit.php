        ...
        <div class="panel panel-default no-radius">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <?php $group=set_value('group')=="cam-nang-tu-van"?$item->group:set_value('group');?>
                        <option value="">Chọn nhóm tin</option>
                        <option <?=$group=="cam-nang-tu-van"?'selected':'';?> value="cam-nang-tu-van">Cẩm nang tư vấn</option>
                        <option <?=$group=="chu-de"?'selected':'';?> value="chu-de">Chủ đề</option>
                    </select>
                </div>
                <div class="form-group">
