...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select class="form-control" name="groups_type" id="groups_type" onchange="change_groups_type_2()">
                ...
                <option value="2">Bất động sản cho thuê </option>
            </select>
     ...
     <div class="col-md-3">
        <div class="form-group">
            ...
            <input class="form-control" name="min_value" value="<?=set_value('min_value');?>">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input class="form-control" name="max_value" value="<?=set_value('max_value');?>">
