...
<div class="row">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" name="full_name" value="<?=set_value('full_name')==""?$item->full_name:set_value('full_name');?>">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label>Email</label>
                    <input type="email" class="form-control" name="email" value="<?=set_value('email')==""?$item->email:set_value('email');?>">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="password" value="<?=set_value('password')==""?$item->password:set_value('password');?>">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="password_again" value="<?=set_value('password_again')==""?$item->password:set_value('password_again');?>">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="form-control" name="role">
                        <?php
                        $role=set_value('role')==""?$item->role:set_value('role');
                        $input=array();
                        $input['where']=array('status'=>1);
                        $list_role=$this->M_roles->get_list($input);
                        foreach ($list_role as $row) { ?>
                            <option value="<?=$row->role;?>" <?=$role==$row->role?"selected":"";?> > <?=$row->name;?></option>
                        <?php
                        }
                        ?>
                    </select>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="facebook" value="<?=set_value('facebook')==""?$item->facebook:set_value('facebook');?>">
    ...
    <div class="col-md-3 text-center">
        <div class="text-center">
            ...
            $url_img=$item->avatar;
            if($url_img==""){
                $url_img=set_value('avatar')==""?base_url()."asset/public/images/avatar-default.png":set_value('avatar');
            }
            ?>
    ...
    <div class="col-md-12">
        ...
        <p class="text-warning">
            <strong><i class="fa fa-hand-o-right"></i> Tài khoản này đang bị khóa.</strong> 
        </p>
        <?php }?>
        <div class="form-group">
