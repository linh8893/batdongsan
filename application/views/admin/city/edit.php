    ...
    <div class="col-md-3">    
        <div class="form-group">
            ...
            <select class="form-control" name="type">
                ...
                <option <?=$type=="Tỉnh"?"selected":"";?>  value="Tỉnh" >Tỉnh</option>
                <option <?=$type=="Thành phố"?"selected":"";?>  value="Thành phố" >Thành phố</option>
            </select>
        </div>
    </div>  
    <div class="col-md-3">
        <div class="form-group">
                    ...
                    <input class="form-control" name="name" id="name" onkeyup="javascript:create_slug('name','slug');" value="<?=set_value('name')==""?$item->name:set_value('name');?>" >
