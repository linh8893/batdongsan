<section id="page">
    ...
    Quý vị nhập thông tin nhà đất cần bán hoặc cho thuê vào các mục dưới đây.<br>
   <span class="text-red" title="Thông tin bắt buộc">(*)</span>  là trường thông tin bắt buộc phải nhập.
                    </div>
                    ...
                    <div class="page-content">
                        <div class="alert alert-success no-radius">
                            ...
                            <p> 
                            Để tin rao của bạn thêm độ tin cậy và hiển thị trên mọi kết quả tìm kiếm.</p>
                        </div> 
                        ...
                        <div class="row ">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="email">Loại tin <span class="text-red" title="Thông tin bắt buộc">(*)</span>: </label>
                                    <div class="col-sm-10">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="email">Nhóm tin <span class="text-red" title="Thông tin bắt buộc">(*)</span>: </label>
                                    <div class="col-sm-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="email">Vị trí <span class="text-red" title="Thông tin bắt buộc">(*)</span>:  </label>
                                    <div class="col-sm-4">
                        ...
                        <!--End row-->
                         <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="email">Giá <span class="text-red" title="Thông tin bắt buộc">(*)</span>: </label>
                                    <div class="col-sm-2">
                        ...
                        <!--End row-->
                         <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="email">Địa chỉ <span class="text-red" title="Thông tin bắt buộc">(*)</span>: </label>
                                    <div class="col-sm-10">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="email">Tiêu đề <span class="text-red" title="Thông tin bắt buộc">(*)</span> :</label>
                                    <div class="col-sm-10">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="email">Nội dung mô tả <span class="text-red" title="Thông tin bắt buộc">(*)</span> :</label>
                                    <div class="col-sm-10">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                <?php $date=strtotime('00:00 '.date('d-m-Y',time())); ?>
                                    <label class="control-label col-sm-2" for="email">Ngày đăng <span class="text-red" title="Thông tin bắt buộc">(*)</span> :</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control no-radius" id="datepicker-1" value="<?=set_value('public_time')==""?date('d-m-Y',time()):set_value('public_time');?>" name="public_time">
                                    </div>
                                    <label class="control-label col-sm-2" for="email" >Ngày hết hạn <span class="text-red" title="Thông tin bắt buộc">(*)</span> : </label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control no-radius" id="datepicker-2"  value="<?=set_value('exp_time')==""?date('d-m-Y',time()+15*24*60*60):set_value('exp_time');?>" name="exp_time">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="email">Họ và tên <span class="text-red" title="Thông tin bắt buộc">(*)</span>: </label>
                                    <div class="col-sm-10">
                                    <?php 
                                    $author_name="";
                                    $author_email="";
                                    ...
                                    if(!empty($account)){
                                        ...
                                        $author_phone=$account['phone'];
                                        $author_address=$account['address'];
                                        $author_email=$account['email'];
                                    }?>
                                        <input type="text" name="author_name" value="<?=set_value('author_name')==""?$author_name:set_value('author_name');?>" class="form-control no-radius">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="email">Địa chỉ <span class="text-red" title="Thông tin bắt buộc">(*)</span> : </label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control no-radius" name="author_address" value="<?=set_value('author_address')==""?$author_address:set_value('author_address');?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="email">Số di động  <span class="text-red" title="Thông tin bắt buộc">(*)</span> : </label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control no-radius" name="author_phone"  value="<?=set_value('author_phone')==""?$author_phone:set_value('author_phone');?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-sm-2" for="email">Email <span class="text-red" title="Thông tin bắt buộc">(*)</span> : </label>
                                    <div class="col-sm-10">
                                        <input type="text" name="author_email" class="form-control no-radius" value="<?=set_value('author_email')==""?$author_email:set_value('author_email');?>">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <button onclick="create_link()" class="btn btn-primary no-radius"> <i class="fa fa-send-o"></i> Đăng tin</button>
