    ...
    Quý vị nhập thông tin nhà đất cần bán hoặc cho thuê vào các mục dưới đây
                    ...
                    <div class="page-content">
                        ...
                        <div class="error"><?=form_error('groups_code');?></div>
                         ...
                         <div class="error"><?=form_error('units');?></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control no-radius" name="cities" id="cities" onchange="change_cities()">
                                            ...
                                            $cities_code=set_value('cities')==""?$item->cities_code:set_value('cities');
                                    ...
                                    <div class="col-sm-4">
                                       <select class="form-control no-radius" name="districts" onchange="change_districts()" id="districts">
                                            <?php 
                                            $districts_code=set_value('districts')==""?$item->districts_code:set_value('districts');

                                            echo '<option  value="" >-- Chọn quận / huyện --</option>';
                                            if($cities_code!=""){
                                                $input=array();
                                                $input['where']=array('cities_code'=>$cities_code);
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        <select class="form-control no-radius" name="wards" id="wards" onchange="change_wards()">
                                            ...
                                            <?php 
                                            $wards_code=set_value('wards')==""?$item->wards_code:set_value('wards');
                                            if($districts_code!=""){
                                                $input=array();
                                                $input['where']=array('districts_code'=>$districts_code);
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control no-radius" name="streets" id="streets" onchange="change_streets()">
                                            ...
                                            <?php 
                                            $streets_code=set_value('streets')==""?$item->streets_code:set_value('streets');
                                            if($districts_code!=""){
                                                $input=array();
                                                $input['where']=array('districts_code'=>$districts_code);
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        <select class="form-control no-radius" name="projects" id="projects" onchange="change_projects()">
                                            ...
                                            <?php 
                                            $projects_code=set_value('projects')==""?$item->projects_code:set_value('projects');
                                            if($districts_code!=""){
                                                $input=array();
                                                $input['where']=array('districts_code'=>$districts_code);
                         ...
                         <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" name="price" value="<?=set_value('price')==""?$item->price:set_value('price');?>" class="form-control no-radius">
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control no-radius" name="units" id="units">
                                            ...
                                            <?php
                                            $units_code=set_value("units")==""?$item->units_code:set_value('units');
                                               if($groups_type==2){
                                                   $input=array();
                                   ...
                                   <label class="control-label col-sm-1 label-right" for="email">Diện tích </label>
                                    <div class="col-sm-2">
                                        <input type="text" name="acreage" value="<?=set_value('acreage')==""?$item->acreage:set_value('acreage');?>" class="form-control no-radius">
                                    </div>
                         ...
                         <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control no-radius" name="address" id="address"   value="<?=set_value('address')==""?$item->address:set_value('address');?>"> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input class="form-control no-radius" type="text" value="<?=set_value('frontside')==""?$item->frontside:set_value('frontside');?>" name="frontside">
                                    </div>
                                    <label class="control-label col-sm-2 label-right" for="email">Đường trước nhà (m) </label>
                                    <div class="col-sm-2">
                                        <input class="form-control no-radius" type="text" value="<?=set_value('backside')==""?$item->backside:set_value('backside');?>" name="backside">
                                    </div>
                                    <label class="control-label col-sm-1 label-right" for="email">Hướng nhà </label>
                                    <div class="col-sm-3">
                                     <?php 
                                            $directions_code=set_value('directions')==""?$item->directions_code:set_value('directions');
                         ...
                         <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-sm-2 " for="email"  >Số tầng </label>
                                    <div class="col-sm-2">
                                        <input class="form-control no-radius" type="text" value="<?=set_value('floor')==""?$item->floor:set_value('floor');?>" name="floor">
                                    </div>
                                    <label class="control-label col-sm-2 label-right" for="email">Số phòng </label>
                                    <div class="col-sm-2">
                                        <input class="form-control no-radius" type="text" name="room" value="<?=set_value('room')==""?$item->room:set_value('room');?>">
                                    </div>
                                    <label class="control-label col-sm-1 label-right" for="email" >Số toilet</label>
                                    <div class="col-sm-3">
                                        <input class="form-control no-radius" type="text" value="<?=set_value('toilet')==""?$item->toilet:set_value('toilet');?>" name="toilet">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control no-radius" name="title" id="title"  value="<?=set_value('title')==""?$item->title:set_value('title');?>" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control no-radius" name="content" rows="5"><?=set_value('content')==""?$item->content:set_value('content');?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control no-radius" id="datepicker-1" value="<?=set_value('public_time')==""?date('d-m-Y',$item->public_time):set_value('public_time');?>" name="public_time">
                                    </div>
                                    <label class="control-label col-sm-2" for="email" >Ngày hết hạn </label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control no-radius" id="datepicker-2"  value="<?=set_value('exp_time')==""?date('d-m-Y',$item->exp_time):set_value('exp_time');?>" name="exp_time">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php if(isset($images[0])){ ?>
                                        <img class="img-responsive" src="<?=base_url().'asset/public/upload/'.$images[0]->name;?>">
                                    <?php
                                    }else{ ?>
<img class="img-responsive" src="<?=base_url().'asset/public/upload/default-batdongsanflan.gif';?>" >
                                        <?php
                                        }
                                        ?>
                                        <input type="file" accept="image/*" value="<?=set_value('image_1');?>" name="image_1"  class="form-control no-radius" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                     ...
                                     <?php if(isset($images[1])){ ?>
                                        <img class="img-responsive" src="<?=base_url().'asset/public/upload/'.$images[1]->name;?>">
                                    <?php
                                    }else{ ?>
<img class="img-responsive" src="<?=base_url().'asset/public/upload/default-batdongsanflan.gif';?>" >
                                        <?php
                                        ...
                                        ?>
                                        <input type="file" accept="image/*" value="<?=set_value('image_2');?>" name="image_2"  class="form-control no-radius" >
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                     <?php if(isset($images[2])){ ?>
                                        <img class="img-responsive" src="<?=base_url().'asset/public/upload/'.$images[2]->name;?>">
                                    <?php
                                    }else{ ?>
<img class="img-responsive" src="<?=base_url().'asset/public/upload/default-batdongsanflan.gif';?>" >
                                        <?php
                                        ...
                                        ?>    
                                        <input type="file" accept="image/*" value="<?=set_value('image_3');?>" name="image_3"  class="form-control no-radius" >
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                     <div class="col-sm-12">
                                      <?php if(isset($images[3])){ ?>
                                        <img class="img-responsive" src="<?=base_url().'asset/public/upload/'.$images[3]->name;?>">
                                    <?php
                                    }else{ ?>
<img class="img-responsive" src="<?=base_url().'asset/public/upload/default-batdongsanflan.gif';?>" >
                                        <?php
                                        ...
                                        ?>    
                                         <input type="file" accept="image/*" value="<?=set_value('image_4');?>" name="image_4"  class="form-control no-radius" >
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="author_name" value="<?=set_value('author_name')==""?$item->author_name:set_value('author_name');?>" class="form-control no-radius">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="email">Địa chỉ </label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control no-radius" name="author_address" value="<?=set_value('author_address')==""?$item->author_address:set_value('author_address');?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control no-radius" name="author_phone"  value="<?=set_value('author_phone')==""?$item->author_phone:set_value('author_phone')?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="author_email" class="form-control no-radius" value="<?=set_value('author_email')==""?$item->author_email:set_value('author_email');?>">
                                    </div>
                                </div>
                            </div>
                        </div>
