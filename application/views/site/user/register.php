            ...
            <form class="form-horizontal" method="post">
                ...
                <?=$this->session->flashdata('msg_admin');?>
                    <div class="col-md-6" id="login-left">
                        <h2><i class="fa fa-plus-circle"></i> Thông tin cá nhân <span class="text-red" title="Thông tin bắt buộc">(*)</span></h2>
                        <div class="form-group">
                            <label class="control-label col-sm-3 " for="email">Họ và tên</label>
                            <div class="col-sm-9">
                              <input class="form-control no-radius" name="full_name" value="<?=set_value('full_name');?>">
                    <div class="error"><?=form_error('full_name');?></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                              <input type="email" class="form-control no-radius" name="email" value="<?=set_value('email');?>">
                    <div class="error"><?=form_error('email');?></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                              <input class="form-control no-radius" name="phone" value="<?=set_value('phone');?>">
                    <div class="error"><?=form_error('phone');?></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                               <input type="password" class="form-control no-radius" name="password" value="<?=set_value('password');?>">
                    <div class="error"><?=form_error('password');?></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                              <input type="password" class="form-control no-radius" name="password_again" value="<?=set_value('password_again');?>">
                    <div class="error"><?=form_error('password_again');?></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                              <input class="form-control no-radius" name="address" value="<?=set_value('address');?>">
                    ...
                    <div class="col-md-6" id="login-right">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                              <input class="form-control no-radius" name="zalo" value="<?=set_value('zalo');?>">
                    <div class="error"><?=form_error('zalo');?></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control no-radius" name="facebook" value="<?=set_value('facebook');?>">
                    <div class="error"><?=form_error('facebook');?></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                               <input class="form-control no-radius" name="skype" value="<?=set_value('skype');?>">
