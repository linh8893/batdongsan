...
?>
                    ...
                    <div class="page-content">
                        ...
                        <p><b>Giá: </b><b style="color: #6898D0;"><?=$price1;?></b></p>
                    ...
                    <div class="page-content">
                        <div id="myCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            $j=0; foreach ($images as $row) { 
                                                    ?>
                                                    <div class="item <?=$j==0?'active':'';?>">
                                <img src="<?=base_url();?>asset/public/upload/<?=$row->name;?>" alt="Chania" width="100%" height="345">
                              </div>
                                                    <?php
                                                    $j++;
                                                } ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-header">
                                <h2><i class="fa fa-plus-circle"></i> Bản đồ</h2>
                            </div>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAjPbE_uEkSxIHe9fhIrsRDJF6nWvQXKSE&callback=initMap"
    async defer></script>
                        </div>
                    </div>
                    <!--End row-->
